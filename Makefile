...
./srcs/turning_matrix.c ./srcs/reverse_turning_matrix.c ./srcs/usage.c ./srcs/errors.c ./srcs/help.c ./srcs/main.c
...
make_coordinate.o move.o open_window.o projection.o read_file.o zoom.o \
turning_matrix.o reverse_turning_matrix.o usage.o errors.o help.o main.o
